...
__DEFINE__(1644843366327, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1644843366328,"./event-store":1644843366329}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644843366328, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1644843366329, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1644843366328,"./utils":1644843366330}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644843366330, function(require, module, exports) {
...
return __REQUIRE__(1644843366327);
})()
